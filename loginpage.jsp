...
<head>
	...
	<style type="text/css">
		...
		.login .l_main{width:500px;height:170px;border:1px dotted #d5d5d5;margin:115px auto;}
            ...
            <div class="login">
            	<div class="l_main">
            		<form action="${pageContext.request.contextPath}/user/login.do" id="loginForm" method="post">
            			<label>账号：</label><input type="text" required id="username" name="loginuser.username"/>
            			<label>密码：</label><input type="password" required id="password" name="loginuser.password"/>
            			<!--<span>登&nbsp;陆</span>-->
            			<input type="submit" value="登 陆" class="button" id="login"/>
            		</form>
            	</div>
            </div>
            <!-- 登陆区代码 -->
