        ...
        <div id="content">
            ...
            <ul id="dt">
	            <s:iterator value="hotAnswerings">
	            	<li>
	            		<a href="${pageContext.request.contextPath}/hotanswer/content.do?id=<s:property value="id"/>"><s:property value="title"/></a>
            ...
            <div style="margin-bottom:10px;margin-top:100px;">
	     		<xy:pager pageIndex="${pageModel.pageIndex}" 
	     				  ...
	     				  submitUrl="${pageContext.request.contextPath}/hotanswer/hotanswer.do?pageModel.pageIndex={0}" />
            </div>
        </div>
    </div>
