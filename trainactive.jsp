        ...
        <div id="content">
            ...
            <ul id="dt">
	            <s:iterator value="trainActives">
	            	<li>
	            		<a href="${pageContext.request.contextPath}/trainactive/content.do?id=<s:property value="id"/>"><s:property value="title"/></a>
	            		<span style="margin-right:5px;"><s:date name="date" format="yyyy-MM-dd"/></span>
	            	</li>
	            </s:iterator>
            </ul>
            <div style="margin-bottom:10px;margin-top:100px;">
	     		<xy:pager pageIndex="${pageModel.pageIndex}" 
	     				  ...
	     				  submitUrl="${pageContext.request.contextPath}/trainactive/trainactive.do?pageModel.pageIndex={0}" />
            </div>
        </div>
    </div>
