        ...
        <div id="container">
              <div id="header"><img src="${pageContext.request.contextPath}/rx/images/logo.jpg" alt="" />
                  ...
                  <form id="form1" action='' >
                      <p>
                          <input type="text" name="reachtext" class="text1" value="" onkeydown="if(event.keyCode==13)return false;"/>
                      </p>
                      <p>
                           <input type="image" src="${pageContext.request.contextPath}/rx/images/search.gif" name="reachtext" class="search" />
                      </p>
                  </form>
              </div>
    <div id="banner">
